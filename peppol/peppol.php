...
hooks()->add_action('after_client_created', 'peppol_client_created');
hooks()->add_action('after_client_updated', 'peppol_client_updated');
...
hooks()->add_action('after_custom_profile_tab_content', 'peppol_add_legal_entity_section');
 ...
 */
function peppol_client_created($client_id)
{
 ...
 */
function peppol_client_updated($data)
{
 ...
 */
function peppol_add_legal_entity_section($client)
{
